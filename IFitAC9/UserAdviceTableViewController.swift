//
//  UserAdviceTableViewController.swift
//  IFitAC9
//
...
class UserAdviceTableViewController: UITableViewController {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        let nibName = UINib(nibName: "UseradviceTableViewCell", bundle: nil)
        tableView.registerNib(nibName, forCellReuseIdentifier: "adviceCell")
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return lineRecordData.recordData.userAdvice.count
    }
